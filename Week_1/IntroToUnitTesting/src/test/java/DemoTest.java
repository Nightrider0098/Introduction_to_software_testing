...
public class DemoTest {
	...
	@Test
	public void test_NOT_triangle_1() {
		assertFalse(Demo.isTriangle(5,7,13));
	}

	@Test
	public void test_NOT_triangle_2() {
		assertFalse(Demo.isTriangle(5,13,7));
	}

	@Test
	public void test_NOT_triangle_3() {
		assertFalse(Demo.isTriangle(13,5,7));
	}

	@Test
	public void test_NOT_triangle_4() {
		assertFalse(Demo.isTriangle(13,7,5));
	}

	@Test
	public void test_NOT_triangle_5() {
		assertFalse(Demo.isTriangle(5,9,3));
	}

	@Test
	public void test_NOT_triangle_6() {
